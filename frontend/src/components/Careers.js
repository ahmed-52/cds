    ...
    return (
                    ...
                    <div className="">
                        ...
                        <div className="md:max-w-[1400px] xlx:mx-auto mx-[50px]">
                            ...
                            <section className="pb-10">
                                <p className="font-shippori font-medium mb-6 text-white md:text-[35px]">
                                <span className="font-extrabold text-[40px]">Why Cornell Data Strategy</span><br></br><br></br>
        ...
        `}
              ...
              <section className="pb-10">
                ...
                <p className="font-shippori text-[20px] mb-6 mt-10 text-white md:text-[25px]">
                  <span className="font-extrabold text-[40px]">What We Look For</span><br></br>
                ...
                <p className="font-shippori text-[20px] mb-6 mt-16 text-white md:text-[25px]">
                  <span className="font-extrabold text-[40px]">When To Apply</span><br></br>
              ...
              <section className="bg-das text-white py-12 px-10 md:px-16 flex flex-col md:flex-row items-center justify-between my-12">
                ...
                <div className="max-w-screen-md">
                  <h2 className="text-[40px] mb-4 font-b1">
                  Interview Process
                  </h2>
                  <p className="text-[22px] font-b1 ">
